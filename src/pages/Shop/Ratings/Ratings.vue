    ...
    <div class="ratings" ref="ratings">
        <div class="ratings-content">
            ...
            <div class="ratingselect">
                ...
                <div class="switch " @click="toggleonlyShowText" :class="{on:onlyShowText}">
...
<script>
    ...
    export default {
        data(){
            return{
                onlyShowText:true,  //true代表只显示文本内容  false 代表全部显示
                selectType:2    //2为全部  0 为满意 1为不满意
            }
        },
        mounted() {
        ...
        computed: {
            ...
            filterRatings(){
                ...
                return ratings.filter((rating) => {
                    ...
                    //条件一 selectType 0/1/2  rateType 0/1
                    //  selectType ===2 || selectType === rateType

                    //条件二 onlyShowText false/true  text 有值或者没有值
