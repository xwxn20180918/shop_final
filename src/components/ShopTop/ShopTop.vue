<template>
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a class="back">
        <i class="iconfont icon-houtui" @click="$router.back()"/>
      </a>
    </nav>
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <i class="content-icon" @click="showType"></i>
        </h2>
    ...
    <div class="shop-header-discounts" v-if="info.supports">
      <div class="discounts-left">
        <div class="activity " :class="classColors[info.supports[0].type]">
          <span class="content-tag">
      ...
      <div class="discounts-right" @click="showColors">
        {{info.supports.length}}个优惠
      </div>
    </div>
    <transition name="move">
      <div class="shop-brief-modal" v-show="isShow">
        <div class="brief-modal-content">
          ...
          <h3 class="brief-modistancedal-title">
            <span>公告</span></h3>
          <div class="brief-modal-notice">
            {{info.bulletin}}
          </div>
          <div class="mask-footer" @click="showType">
            <span class="iconfont icon-guanbi1" ></span>
          </div>
        </div>
        <div class="brief-modal-cover" @click="showType"></div>
      </div>
    </transition>
    <transition name="move">
      <div class="activity-sheet" v-show="showColor">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">
            优惠活动</h2>
          <ul class="list">
            <li class="activity-item " :class="classColors[support.type]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
          ...
          <div class="activity-sheet-close" @click="showColors">
            <span class="iconfont icon-guanbi1" ></span>
          </div>
        </div>
        <div class="activity-sheet-cover" @click="showColors"></div>
      </div>
    </transition>
  </div>
</template>
  ...
  export default {
    data(){
      return{
        isShow :false,
        showColor:false,
        classColors:['activity-green','activity-red','activity-orange']
      }
    },
    methods:{
      showType(){
